#!/bin/bash
#
# Pusha Talk v2.0.1 — Installation Script
#
...
echo "========================================"
echo "  Pusha Talk v2.0.1 — Installer"
echo "========================================"
echo
...
ARCH="$(uname -m)"
if [ "$ARCH" != "arm64" ]; then
    echo "ERROR: Pusha Talk requires Apple Silicon (M1/M2/M3/M4)."
...
echo "Debug mode:"
echo "  voice --debug"
echo "  (logs written to ~/.config/pusha-talk/debug.log)"
echo
